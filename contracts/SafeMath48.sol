...
library SafeMath48 {
     ...
     * _Available since v2.4.0._
     */
    function div(uint48 a, uint48 b, string memory errorMessage) internal pure returns (uint48) {
     ...
     * - The divisor cannot be zero.
     */
    function mod(uint48 a, uint48 b) internal pure returns (uint48) {
     ...
     * _Available since v2.4.0._
     */
    function mod(uint48 a, uint48 b, string memory errorMessage) internal pure returns (uint48) {
        require(b != 0, errorMessage);
        return a % b;
    }
}
