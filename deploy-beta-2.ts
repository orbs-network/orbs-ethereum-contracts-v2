...
async function listGuardians(web3: Web3Driver, guardianRegistrationContractAddr: string): Promise<string[]> {
...
async function deploy() {
    ...
    const guardiansToMigrate = await listGuardians(web3, options.previousGuardianRegistrationContractAddr);
