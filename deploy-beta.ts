...
async function main() {
    ...
    console.log("stakingRewards", d.stakingRewards.address);
    console.log("feesAndBootstrapRewards", d.feesAndBootstrapRewards.address);
    ...
    await printGetters("stakingRewards", d.stakingRewards);
    await printGetters("feesAndBootstrapRewards", d.feesAndBootstrapRewards);
