...
describe('fees-wallet-contract', async () => {
  ...
  it('collects fees', async () => {
    ...
    await d.contractRegistry.setContract("feesAndBootstrapRewards", collector.address, false,{from: d.registryAdmin.address});
  ...
  it('only rewards contract can collect fees', async () => {
    ...
    await d.contractRegistry.setContract("feesAndBootstrapRewards", assigner.address, false, {from: d.registryAdmin.address});
